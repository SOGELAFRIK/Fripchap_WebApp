    ...
    <Box>
      ...
      >
        ...
        <Flex flex={{ base: 1 }} justify={{ base: "center", md: "start" }}>
          ...
          <Flex display={{ base: "none", md: "flex" }} ml={'25%'} fontSize={30} color={'black'}>
            {/* <DesktopNav /> */}
            
            <Link href={"/"} mr={3}>Accueil</Link>
            <Menu isLazy >
              <MenuButton mr={3}>Categories</MenuButton>
              <MenuList>
                {/* MenuItems are not rendered unless Menu is open */}
                <Wrap spacing="30px" align="center" w={"sm"}>
                  {cat.map((index,key)=>(
                    <Link  key={index.id}  href={'/'+index.id}>
            ...
            <Link href={"/Cart"} mr={3}>Panier</Link>
            <Link href={"#"} mr={3}>Paiement</Link>
            <Link href={"#"} mr={3}>Services</Link>
